...
const Notion = () => {
    return (
        <div className='w-full mt-10 px-20'>
            ...
            <div className="flex flex-col gap-5 text-xl text-[#545353] font-medium">
                <div>Semester 1:</div>
                <div>
                    <Link href="#dashboardA" passHref>
